...
public class clsPosiblesClientes {
    ...
    public String getStTwittir() {
        return stTwittir;
    }

    public void setStTwittir(String stTwittir) {
        this.stTwittir = stTwittir;
    }

    public String getStCorreoElectronicoSegundario() {
        return stCorreoElectronicoSegundario;
    }
